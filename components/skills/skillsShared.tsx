...
export function Toggle({ enabled, loading, onToggle }: { enabled: boolean; loading: boolean; onToggle: () => void }) {
  return (
    <button
      onClick={onToggle}
      disabled={loading}
...
export function SkillDetail({
  skill, cwd, onToggle, toggling, saveError,
}: {
  skill: Skill;
  cwd: string;
...
export function useSkillsData(cwd: string) {
  ...
  return { skills, loading, error, toggling, saveError, loadSkills, toggle, setSkills };
}